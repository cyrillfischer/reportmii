// src/components/AnimatedShapesAffiliate.tsx
import { motion } from "framer-motion";
import { useEffect, useState } from "react";

export function AnimatedShapesAffiliate() {
      ...
      {lines.map((l) => (
        <motion.div
          ...
          style={{
            ...
            // Subtile violett-tint → perfekt abgestimmt
            backgroundColor: "rgba(143, 83, 251, 0.22)", // violet-500 soft tint
